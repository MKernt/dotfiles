...
# based on https://github.com/jldeen/dotfiles/blob/wsl/configure.sh
...
echo ''
echo '	Badass WSL terminal installed! Please reboot your computer for changes to be made.' Initialize TMUX plugin manager (keep this line at the very bottom of tmux.conf)TMUX plugin manager (keep this line at the very bottom of tmux.conf)
